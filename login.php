...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST"){
        ...
        //lookup user
        $user_stmt = $conn->prepare("SELECT user_id, handle, password FROM user WHERE handle = ?;");
        ...
        $cookie_value = strval(random_bytes(510));
        setcookie("login_session", $cookie_value, time() + (14 * 60 * 60 * 24), "/");
